...
import com.elearning.ProjetPfe.dto.admin.InstructorStudentDto;
...
import com.elearning.ProjetPfe.dto.course.ResourceDto;
...
import com.elearning.ProjetPfe.service.course.ResourceService;
...
public class InstructorCourseController {
    ...
    // ─── IMAGE de couverture prédéfinie ──────────────────────────────────
    // PUT /api/instructor/courses/5/cover-preset?imageName=course-img1.jpg
    @PutMapping("/{courseId}/cover-preset")
    public ResponseEntity<CourseResponseDto> setPresetCover(
            @PathVariable Long courseId,
            @RequestParam("imageName") String imageName,
            @AuthenticationPrincipal User instructor) {
        return ResponseEntity.ok(courseService.setPresetCoverImage(courseId, imageName, instructor));
    }
    ...
    // PUT /api/instructor/courses/5/unarchive
    @PutMapping("/{courseId}/unarchive")
    public ResponseEntity<CourseResponseDto> unarchiveCourse(
            @PathVariable Long courseId,
            @AuthenticationPrincipal User instructor) {
        return ResponseEntity.ok(courseService.unarchiveCourse(courseId, instructor));
    }
