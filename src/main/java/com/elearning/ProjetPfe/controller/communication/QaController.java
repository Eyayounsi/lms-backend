...
import com.elearning.ProjetPfe.service.communication.QaService;
...
public class QaController {
    ...
    /** GET /api/user/qa/my-questions — Toutes les questions posées par l'utilisateur connecté */
    @GetMapping("/my-questions")
    public ResponseEntity<List<Map<String, Object>>> getMyQuestions(Authentication auth) {
