package com.elearning.ProjetPfe.controller.payment;
...
import com.elearning.ProjetPfe.service.payment.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createCheckoutSession(
        ...
        try {
            Number courseIdNum = (Number) body.get("courseId");
            if (courseIdNum == null) {
                return ResponseEntity.badRequest().body(Map.of("error", "courseId est requis"));
            }
            Long courseId = courseIdNum.longValue();
            String couponCode = body.get("couponCode") != null ? body.get("couponCode").toString().trim() : null;
            ...
            // Créer la session Stripe (avec coupon optionnel)
            Map<String, String> result = paymentService.createCheckoutSession(courseId, student, couponCode);
    ...
    public ResponseEntity<?> confirmPayment(
        ...
        try {
            ...
            paymentService.confirmSessionPayment(sessionId, student.getId());
